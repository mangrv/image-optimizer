...
WATERMARK_TEXT="westwardtrade.com" # Customize your watermark text here
...
ARCHIVE_TIME_LIMIT=200 # Age in minutes to archive the files
FILENAME_PART="westward" # Part of the filename
